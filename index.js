...
const vcard1 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:Alexander\n' //ganti nama lu! 
              + 'ORG: Owner YD-BOT;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6281281783202:+62 81281783202\n'  //ganti nomor lu! 
              + 'END:VCARD'
...
fake = 'SOVIET-BOT-ANTIDELETE'
numbernye = '0'
NamaOwner = 'Alexander Yeremi'
NamaBot = 'Alexander Yeremi'
lolhumankey = 'yogipwkey'
leyskey = 'freeKeY'

//owner number
const ownerNumber = ["6281281783202@s.whatsapp.net","6285876330812@s.whatsapp.net"]   //ganti nomor lu! 
const dappNumber = ["6281281783202@s.whatsapp.net"]  //ganti nomor lu!  
...
client.on('message-new', async (mek) => {
	try {
		...
		if (urutan_pesan === 5000) {
			...
			const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*SOVIET BOT\nCreated by @yogi.prwaa._*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.jpeg')} } }
			const isUrl = (url) => {
